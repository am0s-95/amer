...
description: Design and review goal-oriented agent loops — decidable goals, loop-type selection, and the five failure modes (spinning, verifier gaming, wrong-answer completion). Use when writing or auditing an autonomous agent loop.
metadata:
  origin: ECC
---
