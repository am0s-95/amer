...
description: Builds security-focused full-stack features across frontend, backend, and database in one workflow — auth, input validation, output encoding, parameterized queries. Use for end-to-end features, CRUD with UI, or authenticated API routes with views.
license: MIT
metadata:
