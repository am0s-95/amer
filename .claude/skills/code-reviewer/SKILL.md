---
name: code-reviewer
description: Reviews code diffs and files for bugs, security vulnerabilities, code smells, N+1 queries, and architectural issues, producing a prioritized review report. Use for PR reviews, code quality audits, and refactoring suggestions.
license: MIT
